...
screen = glass.GUI_CreateScreen("demos");
loadingAction = None;

xoffset = 0.55; #size of scroll area as a proportion of screenWidth
padding = 0.01;
pxpadding = 4;
...
def onShow():
	if demos.loadingAction is not None:
		demos.loadingAction.stop();
	demos.list.erase();
	demos.loadingAction = ActionSequence(demos.DemosLoadAction());
...
server = glass.GlassLabel("Recorded on server_name_here");
...
noMap = glass.GlassLabel("^900Map file missing!"); #todo map file download?
...
title = glass.GlassLabel("Select the video you want to upload.");
...
passwordLabel = glass.GlassLabel("Password: ");
...
videoTitle = glass.GlassLabel("Video Title:");
...
videoKeywords = glass.GlassLabel("Keywords:");
...
videoDescription = glass.GlassLabel("Description:");
